...
## Dashboard Structure
The dashboard is structured into multiple interactive sections and two pages to enhance user experience and data interpretation:
...
- Page 2:
  - 📈 Chart Panel: Features trendlines for corn and blueberry production over the years, offering comparisons between different crops. Additionally, it includes a comparative trendline illustrating the Gini Coefficient for avocado-growing versus non-avocado-growing municipalities.
